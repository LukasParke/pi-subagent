...
|--------|-----------------|-------|
| npm | `pi install npm:@lukehagar/pi-subagent@0.1.2` | npm publish + `pi-package` keyword |
| git | `pi install git:github.com/LukasParke/pi-subagent@v0.1.2` | GitHub Release / tag |
...
pi install npm:@lukehagar/pi-subagent@0.1.2

# latest npm
pi install npm:@lukehagar/pi-subagent

# git pin to the release tag
pi install git:github.com/LukasParke/pi-subagent@v0.1.2
